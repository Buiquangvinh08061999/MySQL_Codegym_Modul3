                    ...
                    <fieldset class="row">
                        ...
                        <div class="col-sm-6 mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="password" class="form-control" id="ipnPassword" name="password" value="${user.password}"/>
                        ...
                        <div class="col-sm-6 mt-3">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="txr@gmail.com" value="${user.email}">
                        </div>
